...
public class NotificationHandler {
    private static final String CHANNEL_ID = "gasapplication_notification_channel";
    ...
    public void send(String message) {
        Intent intent = new Intent(mContext, ListedActivity.class);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(mContext, CHANNEL_ID)
                .setContentTitle("neMVM")
                .setContentText(message)
                .setSmallIcon(R.mipmap.nemvm_logo)
